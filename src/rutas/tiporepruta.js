...
var TipoRepModel = require('../modelos/tiporepmodel');
...
module.exports = function () {
    ...
    router.get("/", function (req, res) {
        TipoRepModel.getTiposRep(function (error, data) {
    ...
    router.get("/:id", function (req, res) {
        ...
        if (!isNaN(id)) {
            TipoRepModel.getTipoRep(id, function (error, data) {
    ...
    router.put("/", function (req, res) {
        ...
        var TipoRepData =
        {
            id_tipo_repuesto: req.body.id_tipo_repuesto,
            tipo_repuesto: req.body.tipo_repuesto,
        };


        //usamos la funcion para actualizar
        TipoRepModel.updateTipoRep(TipoRepData, function (error, data) {
            //se muestra el mensaje correspondiente
            if (data && data.msg) {
                res.status(200).json(data);
            }

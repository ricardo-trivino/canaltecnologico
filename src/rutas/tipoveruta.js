...
var TipoVeModel = require('../modelos/tipovemodel');
...
module.exports = function () {
    ...
    router.get("/", function (req, res) {
        TipoVeModel.getTiposVe(function (error, data) {
    ...
    router.get("/:id", function (req, res) {
        ...
        if (!isNaN(id)) {
            TipoVeModel.getTipoVe(id, function (error, data) {
    ...
    router.post("/", function (req, res) {
        ...
        TipoVeModel.insertTipoVe(TipoVeData, function (error, data) {
    ...
    router.put("/", function (req, res) {
        ...
        TipoVeModel.updateTipoVe(TipoVeData, function (error, data) {
            //se muestra el mensaje correspondiente
            if (data && data.msg) {
                res.status(200).json(data);
            }

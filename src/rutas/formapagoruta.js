...
var FormaPagoModel = require('../modelos/formapagomodel');
...
module.exports = function () {
    ...
    router.get("/", function (req, res) {
        FormaPagoModel.getFormasPago(function (error, data) {
    ...
    router.get("/:id", function (req, res) {
        ...
        if (!isNaN(id)) {
            FormaPagoModel.getFormaPago(id, function (error, data) {
    ...
    router.post("/", function (req, res) {
        ...
        FormaPagoModel.insertFormaPago(FormaPagoData, function (error, data) {
    ...
    router.put("/", function (req, res) {
        ...
        FormaPagoModel.updateFormaPago(FormaPagoData, function (error, data) {
            //se muestra el mensaje correspondiente
            if (data && data.msg) {
                res.status(200).json(data);
            }

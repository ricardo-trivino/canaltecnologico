...
var MarcaVeModel = require('../modelos/marcavemodel');
...
module.exports = function () {
    ...
    router.get("/", function (req, res) {
        MarcaVeModel.getMarcasVe(function (error, data) {
    ...
    router.get("/:id", function (req, res) {
        ...
        if (!isNaN(id)) {
            MarcaVeModel.getMarcaVe(id, function (error, data) {
    ...
    router.post("/", function (req, res) {
        ...
        MarcaVeModel.insertMarcaVe(MarcaVeData, function (error, data) {
    ...
    router.put("/", function (req, res) {
        ...
        MarcaVeModel.updateMarcaVe(MarcaVeData, function (error, data) {
            //se muestra el mensaje correspondiente
            if (data && data.msg) {
                res.status(200).json(data);
            }
